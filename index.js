...
try {
  ...
  console.log(
    "[dkto.js | found no package] Automatically installing discord.js ..."
  );
...
const builder = {
  command_options: require("./src/structures/interactions")
    .CreateSlashCommandOptions,
  message_components: require("./src/structures/components")
